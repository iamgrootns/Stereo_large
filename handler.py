...
try:
    ...
    # ✅ ONLY CHANGE: Use musicgen-stereo-large
    model = MusicGen.get_pretrained("facebook/musicgen-stereo-large", device=device)
...
# --- Helper Functions (Identical to working models) ---
